...
!function() {
    ...
    a.render = function(b) {
        ...
        var c = function() {
            ...
            a.render.queue.length ? setTimeout(c) : (a.dispatch.render_end(),
            a.render.active = !1)
        };
        setTimeout(c)
    }
        ...
        function b(l) {
            l.each(function(l) {
                function m() {
                    ...
                    h && (d -= c.left,
                    e -= c.top),
                    0 > d || 0 > e || d > o || e > p || d3.event.relatedTarget && void 0 === d3.event.relatedTarget.ownerSVGElement || i) {
                ...
                i && (i.on("touchmove", m).on("mousemove", m, !0).on("mouseout", m, !0).on("mousedown", m, !0).on("mouseup", m, !0).on("dblclick", m).on("click", m),
                b.guideLine = null,
    ...
    a.models.tooltip = function() {
        ...
        function b() {
            if (!m) {
                ...
                m = d3.select(a).append("div").attr("class", "nvtooltip " + (i ? i : "xy-tooltip")).attr("id", d),
        ...
        return c.nvPointerEventsClass = r,
    ...
    a.utils.windowSize = function() {
        ...
        a) : document.body && document.body.offsetWidth ? (a.width = document.body.offsetWidth,
    ...
    a.utils.customTheme = function(a, b, c) {
        ...
        return function(e, f) {
            var g = b(e);
            return "function" == typeof a[g] ? a[g]() : void 0 !== a[g] ? a[g] : (d || (d = c.length),
            d -= 1,
            c[d])
        }
    }
    ...
    a.utils.renderWatch = function(b, c) {
        ...
        this.models = function(a) {
            return a = [].slice.call(arguments, 0),
    ...
    a.utils.initOption = function(a, b) {
        a._calls && a._calls[b] ? a[b] = a._calls[b] : (a[b] = function(c) {
            return arguments.length ? (a._overrides[b] = !0,
            a._options[b] = c,
            a) : a._options[b]
        }
        ,
    ...
    a.utils.inheritOptions = function(b, c) {
        ...
        b._inherited = a.utils.arrayUnique(d.concat(e).concat(f).concat(d).concat(b._inherited || [])),
    ...
    a.utils.wrapTicks = function(a, b) {
        a.each(function() {
            for (var a, c = d3.select(this), d = c.text().split(/\s+/).reverse(), e = [], f = 0, g = 1.1, h = c.attr("y"), i = parseFloat(c.attr("dy")), j = c.text(null).append("tspan").attr("x", 0).attr("y", h).attr("dy", i + "em"); a = d.pop(); )
                e.push(a),
                j.text(e.join(" ")),
                j.node().getComputedTextLength() > b && (e.pop(),
                j.text(e.join(" ")),
                e = [a],
                j = c.append("tspan").attr("x", 0).attr("y", h).attr("dy", ++f * g + i + "em").text(a))
        })
    }
    ,
        ...
        function b(g) {
            ...
            g.each(function(b) {
                ...
                case "top":
                    ...
                    y = 0,
                    1 === d.range().length ? y = m ? 2 * d.range()[0] + d.rangeBand() : 0 : 2 === d.range().length ? y = m ? d.range()[0] + d.range()[1] + d.rangeBand() : d.range()[1] : d.range().length > 2 && (y = d.range()[d.range().length - 1] + (d.range()[1] - d.range()[0])),
                    v.attr("text-anchor", "middle").attr("y", 0).attr("x", y / 2),
                ...
                case "bottom":
                    ...
                    y = 0,
                    1 === d.range().length ? y = m ? 2 * d.range()[0] + d.rangeBand() : 0 : 2 === d.range().length ? y = m ? d.range()[0] + d.range()[1] + d.rangeBand() : d.range()[1] : d.range().length > 2 && (y = d.range()[d.range().length - 1] + (d.range()[1] - d.range()[0])),
                    v.attr("text-anchor", "middle").attr("y", w).attr("x", y / 2),
                    i && (x = p.selectAll("g.nv-axisMaxMin").data([d.domain()[0], d.domain()[d.domain().length - 1]]),
                    x.enter().append("g").attr("class", function(a, b) {
                        return ["nv-axisMaxMin", "nv-axisMaxMin-x", 0 == b ? "nv-axisMin-x" : "nv-axisMax-x"].join(" ")
                    }).append("text"),
                    x.exit().remove(),
                ...
                case "right":
                    v.enter().append("text").attr("class", "nv-axislabel"),
                    v.style("text-anchor", k ? "middle" : "begin").attr("transform", k ? "rotate(90)" : "").attr("y", k ? -Math.max(e.right, f) + 12 : -10).attr("x", k ? d3.max(d.range()) / 2 : c.tickPadding()),
                    i && (x = p.selectAll("g.nv-axisMaxMin").data(d.domain()),
                    x.enter().append("g").attr("class", function(a, b) {
                ...
                case "left":
                    v.enter().append("text").attr("class", "nv-axislabel"),
                    v.style("text-anchor", k ? "middle" : "end").attr("transform", k ? "rotate(-90)" : "").attr("y", k ? -Math.max(e.left, f) + 25 - (o || 0) : -10).attr("x", k ? -d3.max(d.range()) / 2 : -c.tickPadding()),
                    i && (x = p.selectAll("g.nv-axisMaxMin").data(d.domain()),
                    x.enter().append("g").attr("class", function(a, b) {
                        return ["nv-axisMaxMin", "nv-axisMaxMin-y", 0 == b ? "nv-axisMin-y" : "nv-axisMax-y"].join(" ")
                    }).append("text").style("opacity", 0),
                ...
                !i || "left" !== c.orient() && "right" !== c.orient() || (t.selectAll("g").each(function(a, b) {
                    ...
                    (d(a) < d.range()[1] + 10 || d(a) > d.range()[0] - 10) && ((a > 1e-10 || -1e-10 > a) && d3.select(this).attr("opacity", 0),
            ...
            l.each(function(b) {
                ...
                B.each(function(a, b) {
                    ...
                    ["low", "high"].forEach(function(d) {
                        a.values.hasOwnProperty("whisker_" + d) && null !== a.values["whisker_" + d] && (c.append("line").style("stroke", a.color ? a.color : q(a, b)).attr("class", "nv-boxplot-whisker nv-boxplot-" + d),
                        c.append("line").style("stroke", a.color ? a.color : q(a, b)).attr("class", "nv-boxplot-tick nv-boxplot-" + d))
                    })
                });
                ...
                C.watchTransition(v, "nv-boxplot: nv-boxplot-outlier").attr("cx", .45 * m.rangeBand()).attr("cy", function(a, b, c) {
                    return n(a)
                }).attr("r", "3"),
                C.exit().remove();
                var D = function() {
                ...
                A.select("line.nv-boxplot-median").watchTransition(v, "nv-boxplot: boxplots line").attr("x1", E).attr("y1", function(a, b) {
    ...
    a.models.boxPlotChart = function() {
        ...
        function b(k) {
            ...
            k.each(function(k) {
                ...
                ,
                b.container = this,
                !(k && k.length && k.filter(function(a) {
                ...
                y.append("clipPath").attr("id", "nv-x-label-clip-" + e.id()).append("rect"),
    ...
    a.models.bullet = function() {
        ...
        function b(d) {
            return d.each(function(b, d) {
                ...
                G.select("rect.nv-rangeMax").attr("height", s).attr("width", H(B > 0 ? B : A)).attr("x", I(B > 0 ? B : A)).datum(B > 0 ? B : A),
                G.select("rect.nv-rangeAvg").attr("height", s).attr("width", H(C)).attr("x", I(C)).datum(C),
                G.select("rect.nv-rangeMin").attr("height", s).attr("width", H(B)).attr("x", I(B)).attr("width", H(B > 0 ? A : B)).attr("x", I(B > 0 ? A : B)).datum(B > 0 ? A : B),
                G.select("rect.nv-measure").style("fill", q).attr("height", s / 3).attr("y", s / 3).attr("width", 0 > v ? z(0) - z(v[0]) : z(v[0]) - z(0)).attr("x", I(v)).on("mouseover", function() {
                    r.elementMouseover({
                        value: v[0],
                        label: y[0] || "Current",
    ...
    a.models.bulletChart = function() {
        ...
        function b(d) {
            return d.each(function(e, o) {
                ...
                F.append("text").attr("text-anchor", "middle").attr("dy", "1em").attr("y", 7 * r / 6).text(D);
                ...
                d3.transition(E.exit()).attr("transform", function(a) {
                    return "translate(" + z(a) + ",0)"
    ...
    a.models.candlestickBar = function() {
        ...
        function b(x) {
            return x.each(function(b) {
                ...
                v ? l.range(f || [.5 * x / b[0].values.length, x * (b[0].values.length - .5) / b[0].values.length]) : l.range(f || [5 + A / 2, x - A / 2 - 5]),
                ...
                D.append("clipPath").attr("id", "nv-chart-clip-path-" + k).append("rect"),
                B.select("#nv-chart-clip-path-" + k + " rect").attr("width", x).attr("height", y),
        ...
        function b(l) {
            ...
            l.each(function(l) {
                ...
                if (!(l && l.length && l.filter(function(a) {
                    ...
                    return a.utils.noData(b, L),
                    b;
                if (L.selectAll(".nv-noData").remove(),
                d = f.xScale(),
                e = f.yScale(),
                w)
                    f.yDomain(null);
                ...
                var l = c(G.i, l)
                  ...
                  , W = U.select("g");
                if (V.append("g").attr("class", "nv-interactive"),
                ...
                Y.length && U.append("text").attr("class", "tempDisabled").attr("x", N / 2).attr("y", "-.71em").style("text-anchor", "end").text(Y.map(function(a) {
                    return a.key
                }).join(", ") + " values cannot be calculated for this time period."),
                v && (k.width(N).height(O).margin({
                    left: m.left,
                    top: m.top
                }).svgContainer(L).xScale(d),
                ...
                }).attr("x1", 0).attr("x2", N).attr("y1", aa).attr("y2", aa),
                ...
                r && (g.scale(d)._ticks(a.utils.calcTicksX(N / 70, l)).tickSize(-O, 0),
                W.select(".nv-x.nv-axis").attr("transform", "translate(0," + e.range()[0] + ")"),
                W.select(".nv-x.nv-axis").call(g)),
                s && (h.scale(e)._ticks(a.utils.calcTicksY(O / 36, l)).tickSize(-N, 0),
                ...
                k.dispatch.on("elementMousemove", function(c) {
                    ...
                    if (l.filter(function(a, b) {
                        ...
                        var k = g.values[e];
                        "undefined" != typeof k && ("undefined" == typeof d && (d = k),
                ...
                C.on("changeState", function(a) {
                    ...
                    "undefined" != typeof a.index && (G.i = a.index,
                    G.x = F(G.i),
                    y.index = a.index,
                    ba.data([G])),
        ...
        function c(a, b) {
            ...
            b.map(function(b, c) {
                ...
                if (null == d)
                    return b;
                var e = K(d, a);
                return -.95 > e && !E ? (b.tempDisabled = !0,
                b) : (b.tempDisabled = !1,
    ...
    a.models.discreteBar = function() {
        ...
        function b(m) {
            ...
            m.each(function(b) {
                ...
                o.domain(e || d3.extent(d3.merge(z).map(function(a) {
                    return a.y
                }).concat(r))),
    ...
    a.models.discreteBarChart = function() {
        ...
        function b(h) {
            ...
            h.each(function(h) {
                ...
                if (b.update = function() {
                    t.beforeUpdate(),
                    l.transition().duration(u).call(b)
                }
                ,
                b.container = this,
                !(h && h.length && h.filter(function(a) {
                    return a.values.length
                }).length))
                    return a.utils.noData(b, l),
                    b;
                ...
                if (A.transition().call(e),
                y.append("clipPath").attr("id", "nv-x-label-clip-" + e.id()).append("rect"),
                z.select("#nv-x-label-clip-" + e.id() + " rect").attr("width", c.rangeBand() * (p ? 2 : 1)).attr("height", 16).attr("x", -c.rangeBand() / (p ? 1 : 2)),
                m) {
                    f.scale(c)._ticks(a.utils.calcTicksX(s / 100, h)).tickSize(-v, 0),
                    z.select(".nv-x.nv-axis").attr("transform", "translate(0," + (d.range()[0] + (e.showValues() && d.domain()[0] < 0 ? 16 : 0)) + ")"),
                    z.select(".nv-x.nv-axis").call(f);
                    var B = z.select(".nv-x.nv-axis").selectAll("g");
                    p && B.selectAll("text").attr("transform", function(a, b, c) {
                        return "translate(0," + (c % 2 == 0 ? "5" : "17") + ")"
                    }),
                    r && B.selectAll(".tick text").attr("transform", "rotate(" + r + " 0,0)").style("text-anchor", r > 0 ? "start" : "end"),
                    q && z.selectAll(".tick text").call(a.utils.wrapTicks, b.xAxis.rangeBand())
                }
                n && (g.scale(d)._ticks(a.utils.calcTicksY(v / 36, h)).tickSize(-s, 0),
                z.select(".nv-y.nv-axis").call(g)),
        ...
        var c, d, e = a.models.discreteBar(), f = a.models.axis(), g = a.models.axis(), h = a.models.tooltip(), i = {
            ...
            bottom: 50,
            left: 60
        }, j = null, k = null, l = a.utils.getColor(), m = !0, n = !0, o = !1, p = !1, q = !1, r = 0, s = null, t = d3.dispatch("beforeUpdate", "renderEnd"), u = 250;
        f.orient("bottom").showMaxMin(!1).tickFormat(function(a) {
            return a
        }),
        g.orient(o ? "right" : "left").tickFormat(d3.format(",.1f")),
        h.duration(0).headerEnabled(!1).valueFormatter(function(a, b) {
            return g.tickFormat()(a, b)
    ...
    a.models.distribution = function() {
        ...
        function b(k) {
            ...
            k.each(function(b) {
                ...
                }).attr(k + "1", 0).attr(k + "2", f),
                m.transition(r, "dist").attr(g + "1", function(a, b) {
                    return j(h(a, b))
                }).attr(g + "2", function(a, b) {
                    return j(h(a, b))
                }),
        ...
        b.getData = function(a) {
            return arguments.length ? (h = d3.functor(a),
            b) : h
        }
        ,
        b.scale = function(a) {
        ...
        ,
        b.color = function(c) {
            return arguments.length ? (i = a.utils.getColor(c),
            b) : i
        }
        ,
        ...
        function b(q) {
            ...
            return q.each(function(b) {
                ...
                if ("classic" == p)
                    ...
                    w = x.select("rect"),
                    y.append("g").attr("class", "nv-check-box").property("innerHTML", '<path d="M0.5,5 L22.5,5 L22.5,26.5 L0.5,26.5 L0.5,5 Z" class="nv-box"></path><path d="M5.5,12.8618467 L11.9185089,19.2803556 L31,0.198864511" class="nv-check"></path>').attr("transform", "translate(-10,-8)scale(0.5)");
                ...
                x.on("mouseover", function(a, b) {
                    ...
                    if (l) {
                        if ("classic" == p)
                            ...
                            a.disabled = !1) : (a.disabled = !a.disabled,
                            c.every(function(a) {
                                return a.disabled
                    ...
                    if (("furious" != p || !n) && (o.legendDblclick(a, b),
                    l)) {
                        var c = x.data();
                        c.forEach(function(a) {
                            a.disabled = !0,
                ...
                if (i) {
                    ...
                    x.each(function(b, c) {
                        ...
                        var g;
                        try {
                            if (g = d.node().getComputedTextLength(),
                            0 >= g)
                                throw Error()
                        } catch (i) {
                    ...
                    for (var D = 0, E = 0, F = []; q > E && D < C.length; )
                        F[D] = C[D],
                        E += C[D++];
                    for (0 === D && (D = 1); E > q && D > 1; ) {
                        F = [],
                    ...
                    k ? v.attr("transform", "translate(" + (d - c.right - E) + "," + c.top + ")") : v.attr("transform", "translate(0," + c.top + ")"),
    ...
    a.models.historicalBar = function() {
        ...
        function b(x) {
            return x.each(function(b) {
                ...
                r ? l.range(e || [.5 * x / b[0].values.length, x * (b[0].values.length - .5) / b[0].values.length]) : l.range(e || [0, x]),
                ...
                B.append("clipPath").attr("id", "nv-chart-clip-path-" + j).append("rect"),
                z.select("#nv-chart-clip-path-" + j + " rect").attr("width", x).attr("height", y),
                ...
                E.watchTransition(w, "bars").attr("y", function(b, c) {
    ...
    a.models.historicalBarChart = function(b) {
        ...
        function c(b) {
            return b.each(function(k) {
                ...
                t && (j.width(B).height(C).margin({
                    left: l.left,
                    top: l.top
                }).svgContainer(w).xScale(d),
                E.select(".nv-interactive").call(j)),
                f.width(B).height(C).color(k.map(function(a, b) {
                ...
                H.transition().call(f),
                q && (g.scale(d)._ticks(a.utils.calcTicksX(B / 100, k)).tickSize(-C, 0),
                G.select(".nv-x.nv-axis").attr("transform", "translate(0," + e.range()[0] + ")"),
                G.select(".nv-x.nv-axis").transition().call(g)),
                r && (h.scale(e)._ticks(a.utils.calcTicksY(C / 36, k)).tickSize(-B, 0),
        ...
        k.duration(0).headerEnabled(!1).valueFormatter(function(a, b) {
            return h.tickFormat()(a, b)
        }).headerFormatter(function(a, b) {
            return g.tickFormat()(a, b)
        });
    ...
    a.models.legend = function() {
        ...
        function b(q) {
            function r(a, b) {
                return "furious" != p ? "#000" : n ? a.disengaged ? "#000" : "#fff" : n ? void 0 : (a.color || (a.color = g(a, b)),
            ...
            return q.each(function(b) {
                ...
                if ("classic" == p)
                    ...
                    A.append("g").attr("class", "nv-check-box").property("innerHTML", '<path d="M0.5,5 L22.5,5 L22.5,26.5 L0.5,26.5 L0.5,5 Z" class="nv-box"></path><path d="M5.5,12.8618467 L11.9185089,19.2803556 L31,0.198864511" class="nv-check"></path>').attr("transform", "translate(-10,-8)scale(0.5)");
                ...
                if (i) {
                    ...
                    k ? w.attr("transform", "translate(" + (d - c.right - D) + "," + c.top + ")") : w.attr("transform", "translate(0," + c.top + ")"),
    ...
    a.models.line = function() {
        ...
        function b(r) {
            ...
            r.each(function(b) {
                ...
                B.call(e),
                y.append("clipPath").attr("id", "nv-edge-clip-" + e.id()).append("rect"),
    ...
    a.models.lineChart = function() {
        ...
        function b(j) {
            ...
            j.each(function(j) {
                ...
                F.append("g").attr("class", "nv-legendWrap"),
                F.append("g").attr("class", "nv-interactive"),
                G.select("rect").attr("width", B).attr("height", C > 0 ? C : 0),
                o && (h.width(B),
                G.select(".nv-legendWrap").datum(j).call(h),
                k.top != h.height() && (k.top = h.height(),
                C = a.utils.availableHeight(n, v, k)),
                ...
                s && (i.width(B).height(C).margin({
                    left: k.left,
                    top: k.top
                }).svgContainer(v).xScale(c),
                E.select(".nv-interactive").call(i)),
                e.width(B).height(C).color(j.map(function(a, b) {
                ...
                H.call(e),
                p && (f.scale(c)._ticks(a.utils.calcTicksX(B / 100, j)).tickSize(-C, 0),
                G.select(".nv-x.nv-axis").attr("transform", "translate(0," + d.range()[0] + ")"),
                G.select(".nv-x.nv-axis").call(f)),
                q && (g.scale(d)._ticks(a.utils.calcTicksY(C / 36, j)).tickSize(-B, 0),
            ...
            return v.each(function(v) {
                ...
                function T() {
                    ...
                    la.data([u.empty() ? e.domain() : I]).each(function(a, b) {
                        ...
                        d3.select(this).select(".right").attr("x", e(a[1])).attr("width", 0 > d ? 0 : d)
                    })
                }
                function U() {
                    ...
                    T(),
                    l.width(W).height(X).color(v.map(function(a, b) {
                    ...
                    n.scale(d)._ticks(a.utils.calcTicksX(W / 100, v)).tickSize(-X, 0),
                    ...
                    p.scale(f)._ticks(a.utils.calcTicksY(X / 36, v)).tickSize(-W, 0),
                    q.scale(g)._ticks(a.utils.calcTicksY(X / 36, v)).tickSize($.length ? 0 : -W, 0),
                    ea.select(".nv-focus .nv-y1.nv-axis").style("opacity", $.length ? 1 : 0),
                    ea.select(".nv-focus .nv-y2.nv-axis").style("opacity", _.length && !S(_) ? 1 : 0).attr("transform", "translate(" + d.range()[1] + ",0)"),
                ...
                d.range([0, W]),
                e.domain(d3.extent(d3.merge(aa.concat(ba)), function(a) {
                    return a.x
                })).range([0, W]);
                ...
                if (ga.append("g").attr("class", "nv-x nv-axis"),
                ...
                D) {
                    var ha = t.align() ? W / 2 : W
                      , ia = t.align() ? ha : 0;
                    t.width(ha),
                    ea.select(".nv-legendWrap").datum(v.map(function(a) {
                        return a.originalKey = void 0 === a.originalKey ? a.key : a.originalKey,
                        a.key = a.originalKey + (a.bar ? O : P),
                        a
                    })).call(t),
                    w.top != t.height() && (w.top = t.height(),
                    X = a.utils.availableHeight(z, V, w) - H),
                ...
                m.width(W).height(Y).color(v.map(function(a, b) {
                    return a.color || C(a, b)
                }).filter(function(a, b) {
                    return !v[b].disabled && v[b].bar
                })),
                ...
                G && (o._ticks(a.utils.calcTicksX(W / 100, v)).tickSize(-Y, 0),
                ...
                F && (r.scale(h)._ticks(Y / 36).tickSize(-W, 0),
                s.scale(i)._ticks(Y / 36).tickSize($.length ? 0 : -W, 0),
                ea.select(".nv-context .nv-y3.nv-axis").style("opacity", $.length ? 1 : 0).attr("transform", "translate(0," + e.range()[0] + ")"),
                ea.select(".nv-context .nv-y2.nv-axis").style("opacity", _.length ? 1 : 0).attr("transform", "translate(" + e.range()[1] + ",0)"),
        ...
        function b(o) {
            return o.each(function(o) {
                ...
                function G() {
                    ...
                    U.data([n.empty() ? e.domain() : y]).each(function(a, b) {
                        var d = e(a[0]) - c.range()[0]
                          , f = K - e(a[1]);
                        d3.select(this).select(".left").attr("width", 0 > d ? 0 : d),
                        d3.select(this).select(".right").attr("x", e(a[1])).attr("width", 0 > f ? 0 : f)
                    })
                }
                function H() {
                ...
                w && (p.width(K).height(L).margin({
                    left: q.left,
                    top: q.top
                }).svgContainer(I).xScale(c),
                O.select(".nv-interactive").call(p)),
                g.width(K).height(L).color(o.map(function(a, b) {
                    return a.color || s(a, b)
                }).filter(function(a, b) {
                    return !o[b].disabled
                })),
                ...
                i.scale(c)._ticks(a.utils.calcTicksX(K / 100, o)).tickSize(-L, 0),
                j.scale(d)._ticks(a.utils.calcTicksY(L / 36, o)).tickSize(-K, 0),
                ...
                H(),
                k.scale(e)._ticks(a.utils.calcTicksX(K / 100, o)).tickSize(-M, 0),
                ...
                l.scale(f)._ticks(a.utils.calcTicksY(M / 36, o)).tickSize(-K, 0),
            ...
            E.each(function(b) {
                ...
                u) {
                    ...
                    H.forEach(function(a, c) {
                        a.nonStackable ? (b[c].nonStackableSeries = G++,
                        H[c] = b[c]) : c > 0 && H[c - 1].nonStackable && H[c].values.map(function(a, b) {
                ...
                n.domain(e || d3.extent(d3.merge(I).map(function(a) {
                    var c = a.y;
                    return u && !b[a.idx].nonStackable && (c = a.y > 0 ? a.y1 : a.y1 + a.y),
                    c
                }).concat(s))).range(g || [F, 0]),
                m.domain()[0] === m.domain()[1] && (m.domain()[0] ? m.domain([m.domain()[0] - .01 * m.domain()[0], m.domain()[1] + .01 * m.domain()[1]]) : m.domain([-1, 1])),
                ...
                L.append("clipPath").attr("id", "nv-edge-clip-" + o).append("rect"),
                J.select("#nv-edge-clip-" + o + " rect").attr("width", E).attr("height", F),
                ...
                var P = C.transition(O.exit().selectAll("rect.nv-bar"), "multibarExit", Math.min(100, z)).attr("y", function(a, c, d) {
                    var e = i(0) || 0;
                    return u && b[a.series] && !b[a.series].nonStackable && (e = i(a.y0)),
                    e
                ...
                u ? R.attr("y", function(a, c, d) {
                    ...
                    var e = 0;
                    return b[d].nonStackable && (e = a.series * m.rangeBand() / b.length,
                    b.length !== G && (e = b[d].nonStackableSeries * m.rangeBand() / (2 * G))),
                    e
                }).attr("width", function(a, c, d) {
                    if (b[d].nonStackable) {
                        var e = m.rangeBand() / G;
                        return b.length !== G && (e = m.rangeBand() / (2 * G)),
                        e
                    }
                    return m.rangeBand()
    ...
    a.models.multiBarChart = function() {
        ...
        function b(j) {
            ...
            j.each(function(j) {
                ...
                var K = A.selectAll("g.nv-wrap.nv-multiBarWithLegend").data([j])
                  ...
                  , M = K.select("g");
                if (L.append("g").attr("class", "nv-x nv-axis"),
                ...
                o) {
                    ...
                    M.select(".nv-controlsWrap").datum(N).attr("transform", "translate(0," + -k.top + ")").call(i)
                }
                K.attr("transform", "translate(" + k.left + "," + k.top + ")"),
                t && M.select(".nv-y.nv-axis").attr("transform", "translate(" + E + ",0)"),
                e.disabled(j.map(function(a) {
                    return a.disabled
                ...
                if (O.call(e),
                r) {
                    f.scale(c)._ticks(a.utils.calcTicksX(E / 100, j)).tickSize(-I, 0),
                    ...
                    if (P.selectAll("line, text").style("opacity", 1),
                    v) {
                        var Q = function(a, b) {
                    ...
                    u && P.filter(function(a, b) {
                        return b % Math.ceil(j[0].values.length / (E / 100)) !== 0
                    }).selectAll("text, line").style("opacity", 0),
                    x && P.selectAll(".tick text").attr("transform", "rotate(" + x + " 0,0)").style("text-anchor", x > 0 ? "start" : "end"),
                    M.select(".nv-x.nv-axis").selectAll("g.nv-axisMaxMin text").style("opacity", 1)
                }
                s && (g.scale(d)._ticks(a.utils.calcTicksY(I / 36, j)).tickSize(-E, 0),
                ...
                B.on("changeState", function(a) {
                    ...
                    y.disabled = a.disabled),
                    "undefined" != typeof a.stacked && (e.stacked(a.stacked),
                    y.stacked = a.stacked,
                    F = a.stacked),
                    b.update()
                })
        ...
        var c, d, e = a.models.multiBar(), f = a.models.axis(), g = a.models.axis(), h = a.models.legend(), i = a.models.legend(), j = a.models.tooltip(), k = {
            ...
            bottom: 50,
            left: 60
        }, l = null, m = null, n = a.utils.defaultColor(), o = !0, p = {}, q = !0, r = !0, s = !0, t = !1, u = !0, v = !1, w = !1, x = 0, y = a.utils.state(), z = null, A = null, B = d3.dispatch("stateChange", "changeState", "renderEnd"), C = function() {
            return o ? 180 : 0
        }, D = 250;
        y.stacked = !1,
        e.stacked(!1),
        f.orient("bottom").tickPadding(7).showMaxMin(!1).tickFormat(function(a) {
            return a
        }),
        g.orient(t ? "right" : "left").tickFormat(d3.format(",.1f")),
        j.duration(0).valueFormatter(function(a, b) {
            return g.tickFormat()(a, b)
        }).headerFormatter(function(a, b) {
            return f.tickFormat()(a, b)
        }),
    ...
    a.models.multiBarHorizontal = function() {
        ...
        function b(m) {
            ...
            m.each(function(b) {
                ...
                n = d3.select(this),
                a.utils.initSVG(n),
                w && (b = d3.layout.stack().offset("zero").values(function(a) {
                    return a.values
                }).y(r)(b)),
                b.forEach(function(a, b) {
                    a.values.forEach(function(c) {
                ...
                p.domain(e || d3.extent(d3.merge(F).map(function(a) {
                ...
                L.append("rect").attr("width", 0).attr("height", o.rangeBand() / (w ? 1 : b.length)),
                ...
                s(b[0], 0) && (L.append("polyline"),
                K.select("polyline").attr("fill", "none").attr("points", function(a, c) {
                    var d = s(a, c)
                ...
                L.append("text"),
                x && !w ? (K.select("text").attr("text-anchor", function(a, b) {
                ...
                y && !w ? (L.append("text").classed("nv-bar-label", !0),
                K.select("text.nv-bar-label").attr("text-anchor", function(a, b) {
    ...
    a.models.multiBarHorizontalChart = function() {
        ...
        function b(j) {
            ...
            j.each(function(j) {
                ...
                s && (g.scale(d)._ticks(a.utils.calcTicksX(C / 100, j)).tickSize(-D, 0),
        ...
        function b(j) {
            return j.each(function(j) {
                ...
                if (i) {
                    ...
                    C.width(Y),
                    C.color(X),
                    W.select(".legendWrap").datum(j.map(function(a) {
                        return a.originalKey = void 0 === a.originalKey ? a.key : a.originalKey,
                        a.key = a.originalKey + (1 == a.yAxis ? "" : " (right axis)"),
                        a
                    })).call(C),
                    e.top != C.height() && (e.top = C.height(),
                    J = a.utils.availableHeight(h, H, e)),
                ...
                q.domain(d || d3.extent(d3.merge(T).concat(ha), function(a) {
                    return a.y
                })).range([0, J]),
                r.yDomain(p.domain()),
                t.yDomain(p.domain()),
                ...
                W.select(".nv-y1.nv-axis").classed("nv-disabled", S.length ? !1 : !0).attr("transform", "translate(" + o.range()[0] + ",0)"),
                W.select(".nv-y2.nv-axis").classed("nv-disabled", T.length ? !1 : !0).attr("transform", "translate(" + o.range()[1] + ",0)"),
    ...
    a.models.ohlcBar = function() {
        ...
        function b(y) {
            return y.each(function(b) {
                ...
                v ? l.range(e || [.5 * y / b[0].values.length, y * (b[0].values.length - .5) / b[0].values.length]) : l.range(e || [5 + B / 2, y - B / 2 - 5]),
                ...
                E.append("clipPath").attr("id", "nv-chart-clip-path-" + j).append("rect"),
                C.select("#nv-chart-clip-path-" + j + " rect").attr("width", y).attr("height", A),
                G.attr("clip-path", w ? "url(#nv-chart-clip-path-" + j + ")" : "");
                var H = C.select(".nv-ticks").selectAll(".nv-tick").data(function(a) {
                    return a
                });
                H.exit().remove(),
                H.enter().append("path").attr("class", function(a, b, c) {
                    return (p(a, b) > q(a, b) ? "nv-tick negative" : "nv-tick positive") + " nv-tick-" + c + "-" + b
                }).attr("d", function(a, b) {
            ...
            return p.each(function(b) {
                function p(a) {
                    return F(h.map(function(b) {
                        ...
                        return J.length > 0 ? (D.style("display", "inline"),
                        E.style("display", "inline")) : (D.style("display", "none"),
                ...
                h.forEach(function(a) {
                    ...
                    c[0] === c[1] && (c[0] = c[0] - 1,
                    c[1] = c[1] + 1),
                    g[a] = d3.scale.linear().domain(c).range([.9 * (x - 12), 0]),
                ...
                E.enter().append("text"),
                E.exit().remove(),
                E.attr("y", x).attr("x", w - 92 - I / 2).text(function(a) {
                    return a
                });
                ...
                N.exit().remove(),
                N.select(".nv-label").style("cursor", "move").attr("dy", "-1em").attr("text-anchor", "middle").text(String).on("mouseover", function(a, b) {
                    o.elementMouseover({
                        dim: a,
        ...
        function b(E) {
            ...
            E.each(function(b) {
                ...
                for (var M = 0; M < b[0].length; M++) {
                    ...
                    p && (S.innerRadius(J[M]),
                    T.innerRadius(J[M])),
                    S.cornerRadius && x && (S.cornerRadius(x),
                    T.cornerRadius(x)),
                    B.push(S),
                    C.push(T)
                }
                ...
                p && q && (R.append("text").attr("class", "nv-pie-title"),
                N.select(".nv-pie-title").style("text-anchor", "middle").text(function(a) {
                    return q
                ...
                l) {
                    for (var Y = [], M = 0; M < b[0].length; M++)
                        Y.push(B[M]),
                        m ? p && (Y[M] = d3.svg.arc().outerRadius(B[M].outerRadius()),
                        u !== !1 && Y[M].startAngle(u),
                        w !== !1 && Y[M].endAngle(w)) : p || Y[M].innerRadius(0);
                    W.enter().append("g").classed("nv-label", !0).each(function(a, b) {
                        ...
                        c.attr("transform", function(a, b) {
                            if (t) {
                                ...
                                return (a.startAngle + a.endAngle) / 2 < Math.PI ? c -= 90 : c += 90,
                                "translate(" + Y[b].centroid(a) + ") rotate(" + c + ")"
                            }
                            return a.outerRadius = H + 10,
                            a.innerRadius = H + 15,
        ...
        function b(e) {
            ...
            e.each(function(e) {
                ...
                !m) {
                    ...
                    m = {};
                    for (q in l)
                        l[q]instanceof Array ? m[q] = l[q].slice(0) : m[q] = l[q]
                }
                if (!e || !e.length)
                    return a.utils.noData(b, k),
                    b;
                ...
                i)
                    if ("top" === j)
                        ...
                        d.width(w),
                        n -= d.width(),
                        t.select(".nv-legendWrap").datum(e).call(d).attr("transform", "translate(" + n + ",0)")
                    }
            ...
            N.each(function(b) {
                function N() {
                    ...
                    if (M === !0) {
                        ...
                        if (0 == a.length)
                            return !1;
                        a.length < 3 && (a.push([m.range()[0] - 20, n.range()[0] - 20, null, null]),
                        ...
                        if (C && f.style("fill", d3.rgb(230, 230, 230)).style("fill-opacity", .4).style("stroke-opacity", 1).style("stroke", d3.rgb(200, 200, 200)),
                        B) {
                ...
                y && b[0] ? m.range(G || [(R * z + R) / (2 * b[0].values.length), R - R * (1 + z) / (2 * b[0].values.length)]) : m.range(G || [0, R]),
                n.domain(F || d3.extent(T.map(function(a) {
                    return a.y
                }).concat(u))).range(H || [S, 0]),
                o.domain(I || d3.extent(T.map(function(a) {
                    return a.size
                }).concat(v))).range(J || Q),
                ...
                W.append("clipPath").attr("id", "nv-edge-clip-" + k).append("rect"),
                U.select("#nv-edge-clip-" + k + " rect").attr("width", R).attr("height", S > 0 ? S : 0),
                ...
                $.exit().remove(),
                Z.exit().selectAll("path.nv-point").watchTransition(P, "scatter exit").attr("transform", function(a) {
    ...
    a.models.scatterChart = function() {
        ...
        function b(z) {
            ...
            z.each(function(z) {
                ...
                var J = m.selectAll("g.nv-wrap.nv-scatterChart").data([z])
                  ...
                  , L = K.append("g")
                  , M = J.select("g");
                if (L.append("rect").attr("class", "nvd3 nv-background").style("pointer-events", "none"),
                ...
                s) {
                    ...
                    j.top != f.height() && (j.top = f.height(),
                    H = a.utils.availableHeight(l, m, j)),
                    J.select(".nv-legendWrap").attr("transform", "translate(0," + -j.top + ")")
                }
                J.attr("transform", "translate(" + j.left + "," + j.top + ")"),
                c.width(G).height(H).color(z.map(function(a, b) {
                    return a.color = a.color || n(a, b),
                    a.color
                }).filter(function(a, b) {
                    return !z[b].disabled
                })),
                ...
                t && (d.scale(o)._ticks(a.utils.calcTicksX(G / 100, z)).tickSize(-H, 0),
                M.select(".nv-x.nv-axis").attr("transform", "translate(0," + p.range()[0] + ")").call(d)),
                u && (e.scale(p)._ticks(a.utils.calcTicksY(H / 36, z)).tickSize(-G, 0),
                M.select(".nv-y.nv-axis").call(e)),
                q && (g.getData(c.x()).scale(o).width(G).color(z.map(function(a, b) {
                    return a.color || n(a, b)
                }).filter(function(a, b) {
                    return !z[b].disabled
                })),
                L.select(".nv-distWrap").append("g").attr("class", "nv-distributionX"),
                M.select(".nv-distributionX").attr("transform", "translate(0," + p.range()[0] + ")").datum(z.filter(function(a) {
                    return !a.disabled
                })).call(g)),
                r && (h.getData(c.y()).scale(p).width(H).color(z.map(function(a, b) {
                    return a.color || n(a, b)
                }).filter(function(a, b) {
                    return !z[b].disabled
                })),
                L.select(".nv-distWrap").append("g").attr("class", "nv-distributionY"),
                M.select(".nv-distributionY").attr("transform", "translate(" + (v ? G : -h.size()) + ",0)").datum(z.filter(function(a) {
                    return !a.disabled
                })).call(h)),
                ...
                c.dispatch.on("elementMouseover.tooltip", function(a) {
                    ...
                    m.select(".nv-series-" + a.seriesIndex + " .nv-disty-" + a.pointIndex).attr("x2", a.relativePos[0] + g.size()),
                    i.data(a).hidden(!1)
                }),
                B = o.copy(),
                C = p.copy()
        ...
        g.axis("x"),
        h.axis("y"),
        i.headerFormatter(function(a, b) {
                ...
                function r() {
                    function a(a, b) {
                        for (var c = Math.abs(e.x()(a[0], 0) - b), d = 0, f = 0; f < a.length; f++)
                            Math.abs(e.x()(a[f], f) - b) < c && (c = Math.abs(e.x()(a[f], f) - b),
                            d = f);
                        return d
                    }
                    if (!j) {
                        var b = d3.mouse(this)[0] - f.left;
                        i = [a(p, Math.round(c.invert(b)))],
                        q()
                    }
                }
    ...
    a.models.stackedArea = function() {
        ...
        function b(m) {
            ...
            m.each(function(m) {
                ...
                r.width(s).height(v).x(k).y(function(a) {
                ...
                D.call(r),
                A.append("clipPath").attr("id", "nv-edge-clip-" + i).append("rect"),
                y.select("#nv-edge-clip-" + i + " rect").attr("width", s).attr("height", v),
    ...
    a.models.stackedAreaChart = function() {
        ...
        function b(k) {
            ...
            k.each(function(k) {
                ...
                var P = z.selectAll("g.nv-wrap.nv-stackedAreaChart").data([k])
                  ...
                  , R = P.select("g");
                if (Q.append("rect").style("opacity", 0),
                ...
                if (p) {
                    ...
                    l.top != Math.max(i.height(), h.height()) && (l.top = Math.max(i.height(), h.height()),
                    N = a.utils.availableHeight(n, z, l)),
                ...
                u && (j.width(M).height(N).margin({
                    left: l.left,
                    top: l.top
                }).svgContainer(z).xScale(c),
                P.select(".nv-interactive").call(j)),
                e.width(M).height(N);
                var U = R.select(".nv-stackedWrap").datum(k);
                if (U.transition().call(e),
                r && (f.scale(c)._ticks(a.utils.calcTicksX(M / 100, k)).tickSize(-N, 0),
                R.select(".nv-x.nv-axis").attr("transform", "translate(0," + N + ")"),
                R.select(".nv-x.nv-axis").transition().duration(0).call(f)),
                s) {
                    var V;
                    if (V = "wiggle" === e.offset() ? 0 : a.utils.calcTicksY(N / 36, k),
                ...
                j.dispatch.on("elementMousemove", function(c) {
                    ...
                    if (k.filter(function(a, b) {
                        ...
                        var k = f.values[g]
                          , m = b.y()(k, g);
                        if (null != m && e.highlightPoint(j, g, !0),
                        "undefined" != typeof k) {
                    ...
                    "expand" === e.style() || "stack_percent" === e.style() ? (G || (G = q),
                    q = d3.format(".1%")) : G && (q = G,
                    G = null),
                    j.tooltip.chartContainer(H.parentNode).valueFormatter(q).data({
                        value: p,
                        series: i
                    })(),
                    j.renderGuideLine(h)
                ...
                A.on("changeState", function(a) {
                    ...
                    "undefined" != typeof a.style && (e.style(a.style),
                    I = a.style),
                    b.update()
                })
            }),
        ...
        var c, d, e = a.models.stackedArea(), f = a.models.axis(), g = a.models.axis(), h = a.models.legend(), i = a.models.legend(), j = a.interactiveGuideline(), k = a.models.tooltip(), l = {
            ...
            bottom: 50,
            left: 60
        }, m = null, n = null, o = a.utils.defaultColor(), p = !0, q = !0, r = !0, s = !0, t = !1, u = !1, v = !0, w = "TOTAL", x = a.utils.state(), y = null, z = null, A = d3.dispatch("stateChange", "changeState", "renderEnd"), B = 250, C = ["Stacked", "Stream", "Expanded"], D = {}, E = 250;
        x.style = e.style(),
        f.orient("bottom").tickPadding(7),
        g.orient(t ? "right" : "left"),
    ...
    a.models.sunburst = function() {
        ...
        function b(u) {
            ...
            u.each(function(b) {
                ...
                e = b[0],
                r.value(j[i] || j.count),
                v = B.data(r.nodes).enter().append("path").attr("d", s).style("fill", function(a) {
        ...
        }, k = Math.floor(1e4 * Math.random()), l = null, m = a.utils.defaultColor(), n = 500, o = d3.dispatch("chartClick", "elementClick", "elementDblClick", "elementMousemove", "elementMouseover", "elementMouseout", "renderEnd"), p = d3.scale.linear().range([0, 2 * Math.PI]), q = d3.scale.sqrt(), r = d3.layout.partition().sort(null).value(function(a) {
            return 1
